...
{    
    ...
    Student *thestud = new Student(34,"Noah","Sophomore");
    Student *thestud2 = new Student(345,"Isabel","Junior","PR and Ad");
    Student *stud3 = new Student(34);
    studentTree -> insert(thestud2);
    studentTree -> insert(thestud);
    cout << (thestud == thestud)  <<endl;
    ...
    //     cout << studentTree -> getNodeData(tempStudent) <<endl;
    // }
    // // else if (inNum == 4)
    // // {
    // //     cout << "Please enter the id number of the faculty member you wish to view." << endl;
    // //     cin >> inNum;
    // //     facultyTreeHelper->displayById(facultyTree, inNum);
    // // }
